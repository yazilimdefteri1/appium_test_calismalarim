...
public class Appium05_Chrome_02 {
    @Test
    ...
    public void test() throws MalformedURLException, InterruptedException {
        ...
        //LOCATE ALMANIN 2. YOLU
        //remote devices on chrome --> https://developer.chrome.com/docs/devtools/remote-debugging/
        // sonra bu komutu new tab' açarak yazıyoruz  --->  chrome://inspect/#devices

        driver.findElementById("nav-progressive-greeting").click();

        String expectedMesaj="Welcome";
        String actualMesaj=driver.findElementByXPath("//h2").getText();
